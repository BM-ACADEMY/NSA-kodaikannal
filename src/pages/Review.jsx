...
const reviews = [
  {
    ...
    content: "A quite calm hotel situated in a busy area. The staff were very polite, friendly and have helping tendency. Rooms are well maintained.",
  },
  {
    
    content: "Good family room in Kodaikanal, reasonable price, all facilities are good. Except breakfast. And very good front desk staff",
  },
  {
  ...
  {
    content: "The tent stay was a perfect gateway! The location was peaceful, surrounded by nature. The tents were comfortable, and the bonfire night was unforgettable.",
  },
  {
...
const ReviewSlider = () => {
  ...
  return (
    <div className="review-section py-5 mb-5" id="reviews">
      <h2 className="text-center mb-4 text-uppercase" style={{fontWeight: '600', color:"red"}}>Our Testimonials</h2>
